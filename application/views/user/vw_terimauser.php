				...
				<div class="card mt-4 ms-2 me-5" style="width:25rem;">
					<div class="card-body">
						...
						<?php if ($a['status'] == 'Selesai'): ?>
							<form action="<?php echo base_url('Teknisi/ratingUser/').$a['id_teknisi']; ?>" method="post">
								<div class="col text-center mt-3">
									<label class="mb-2">Silahkan beri Rating untuk Teknisi Kami (1-5) </label>
									<input type="text" name="rating" class="form-control w-25 m-auto">
									<input type="hidden" name="idp" class="form-control w-25 m-auto" value="<?php echo $a['id_pesanan']; ?>">
									<button type="submit" class="btn text-light px-5 mt-3 me-2" style="background:#536D5A">Selesai</button>
								</div>
							</form>
						<?php endif ?>
					</div>
